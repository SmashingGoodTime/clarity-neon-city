...
assertContains(game, "FIRST RUN: keep it simple.", "first run help section");
assertContains(game, "The deeper systems will surface when they matter.", "first run help hint");
assertContains(game, "Advanced systems", "advanced help section");
assertFunctionContains(game, "openToolsMenu", "#tools-history", "more menu history button");
assertFunctionContains(game, "openToolsMenu", "openRunHistoryModal()", "more menu history action");
assertFunctionContains(game, "openToolsMenu", "#tools-export", "more menu export button");
assertFunctionContains(game, "openToolsMenu", "openExportImportModal()", "more menu export action");
assertFunctionContains(game, "openToolsMenu", "#tools-reset", "more menu reset button");
assertFunctionContains(game, "openToolsMenu", 'confirm("Reset progress in the active save slot?")', "more menu reset confirmation");
assertFunctionContains(game, "openToolsMenu", "resetGame()", "more menu reset action");
assertContains(game, '$("#btn-more").addEventListener("click", openToolsMenu);', "more button event listener");
assertNotContains(game, '$("#btn-history").addEventListener', "old history toolbar listener removed");
assertNotContains(game, '$("#btn-export").addEventListener', "old export toolbar listener removed");
assertNotContains(game, '$("#btn-reset").addEventListener', "old reset toolbar listener removed");
assertContains(game, 'const hudMute = document.querySelector("#hud-mute");', "hud mute label separate from title");
assertContains(game, 'hudMute.textContent = this.muted ? "UNMUTE" : "MUTE";', "hud mute plain toggle label");
assertNotContains(game, 'document.querySelectorAll("#title-mute, #hud-mute")', "shared mute label updater removed");
